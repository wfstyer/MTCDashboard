Public Class Frm_TMT
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        DataSet18.Clear()
        DataSet18.ReadXml(machinecall)
        'DataGridView1.DataSource = DataSet18

        TextBox1.Text = DataSet18.Tables("RotaryVelocity").Rows(0).Item(4)
        TextBox12.Text = DataSet18.Tables("RotaryVelocity").Rows(1).Item(4)
        yPos = 419 - Int(DataSet18.Tables("RotaryVelocity").Rows(0).Item(4) / 13)
        Try
            S2rpm = 419 - Int(DataSet18.Tables("RotaryVelocity").Rows(1).Item(4) / 13)
        Catch
            S2rpm = 419
            TextBox12.Text = "0"
        End Try

        TextBox2.Text = DataSet18.Tables("PartCount").Rows(0).Item(3)

        Dim opnofound As Integer = InStr(Trim(DataSet18.Tables("ProgramComment").Rows(1).Item(4)), ":", CompareMethod.Text) + 1
        TextBox10.Text = Mid((Trim(DataSet18.Tables("ProgramComment").Rows(1).Item(4))), opnofound, 4)
        Dim jobnofound As Integer = InStr(opnofound, Trim(DataSet18.Tables("ProgramComment").Rows(1).Item(4)), ":", CompareMethod.Text) + 1
        TextBox9.Text = Mid((Trim(DataSet18.Tables("ProgramComment").Rows(1).Item(4))), jobnofound, 5)



        'TextBox9.Text = Mid((Trim(DataSet18.Tables("ProgramComment").Rows(1).Item(4))), 1, 5) ' job number
        'TextBox10.Text = Mid((Trim(DataSet18.Tables("ProgramComment").Rows(1).Item(4))), 7, 4) ' operation number


        TextBox3.Text = DataSet18.Tables("Load").Rows(1).Item(3)
        TextBox11.Text = DataSet18.Tables("Load").Rows(3).Item(3)
        Try
            Spindleload = 419 - Int(DataSet18.Tables("Load").Rows(1).Item(3) * 3)
        Catch ex As Exception
            'MsgBox(ex.Message)
        End Try
        Try
            S2load = 419 - Int(DataSet18.Tables("Load").Rows(3).Item(3) * 3)
        Catch ex As Exception
            S2load = 419
            TextBox11.Text = "0"
            'MsgBox(ex.Message)
        ...
        TextBox4.Text = DataSet18.Tables("Load").Rows(4).Item(3)
        Xaxisload = 419 - Int(DataSet18.Tables("Load").Rows(4).Item(3) * 3)
        TextBox5.Text = DataSet18.Tables("Load").Rows(0).Item(3)
        Yaxisload = 419 - Int(DataSet18.Tables("Load").Rows(0).Item(3) * 3)
        TextBox6.Text = DataSet18.Tables("Load").Rows(6).Item(3)
        Zaxisload = 419 - Int(DataSet18.Tables("Load").Rows(6).Item(3) * 3)

        TextBox7.Text = DataSet18.Tables("PathFeedrateOverride").Rows(0).Item(4)
        ...
        End Select
        TextBox8.Text = DataSet18.Tables("PathFeedrateOverride").Rows(1).Item(4)
        ...
        End Select
        TextBox13.Text = DataSet18.Tables("EmergencyStop").Rows(0).Item(3)
